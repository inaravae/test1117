    ...
    def _get_model_info(self, model: str, credentials: dict, model_parameters: dict) -> dict:
        ...
        if inference_profile_id:
            ...
            if model_parameters.pop('cross-region', False):
                ...
                # Claude 4.5 Haiku and Claude 3.5 Haiku always use region-specific prefix (not global)
                # Other Claude 4 series models support global prefix
                is_haiku_4_5_or_3_5 = (model_id.startswith('anthropic.claude-haiku-4-5') or 
                                       model_id.startswith('anthropic.claude-3-5-haiku'))
                
                if is_haiku_4_5_or_3_5:
                    # Haiku models always use region-specific prefix
